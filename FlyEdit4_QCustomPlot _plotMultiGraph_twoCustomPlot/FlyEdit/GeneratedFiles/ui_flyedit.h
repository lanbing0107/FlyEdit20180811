...
public:
    ...
    QTableWidget *tableWidget_paraListCheck;
    QCustomPlot *customPlot_paraCheckedOriginal;
    QCustomPlot *customPlot_paraCheckedNormalization;
    QMenuBar *menuBar;
    ...
    void setupUi(QMainWindow *FlyEditClass)
    {
        ...
        pushButton_ImportExcel->setGeometry(QRect(120, 10, 141, 23));
        ...
        pushButton_ExportToExcel->setGeometry(QRect(310, 10, 141, 23));
        groupBox_2 = new QGroupBox(centralWidget);
        groupBox_2->setObjectName(QStringLiteral("groupBox_2"));
        groupBox_2->setGeometry(QRect(20, 40, 201, 541));
        treeView_paraList = new QTreeView(groupBox_2);
        treeView_paraList->setObjectName(QStringLiteral("treeView_paraList"));
        treeView_paraList->setGeometry(QRect(11, 21, 181, 509));
        groupBox_3 = new QGroupBox(centralWidget);
        groupBox_3->setObjectName(QStringLiteral("groupBox_3"));
        groupBox_3->setGeometry(QRect(230, 40, 271, 541));
        ...
        tableWidget_paraListCheck->setGeometry(QRect(510, 60, 161, 511));
        customPlot_paraCheckedOriginal = new QCustomPlot(centralWidget);
        customPlot_paraCheckedOriginal->setObjectName(QStringLiteral("customPlot_paraCheckedOriginal"));
        customPlot_paraCheckedOriginal->setGeometry(QRect(684, 13, 611, 321));
        customPlot_paraCheckedNormalization = new QCustomPlot(centralWidget);
        customPlot_paraCheckedNormalization->setObjectName(QStringLiteral("customPlot_paraCheckedNormalization"));
        customPlot_paraCheckedNormalization->setGeometry(QRect(684, 337, 611, 311));
        ...
        groupBox_2->raise();
        tableWidget_paraListCheck->raise();
        customPlot_paraCheckedOriginal->raise();
        customPlot_paraCheckedNormalization->raise();
